...
public class TopicTabDetailPager extends MenuDetailBasePager {
    ...
    @ViewInject(R.id.pullToRefreshListView)    // 下拉刷新列表(在该列表中还要添加顶部轮播图，其后实现)
    ...
    private static final String TAG = TopicTabDetailPager.class.getSimpleName();
    ...
    // 构造器
    public TopicTabDetailPager(Context context, NewsCenterBean_Hand.NewsCenterBean_Data.Children_Data data) {
        super(context);
    ...
    public View initView() {    // 视图
        ...
        View view = View.inflate(context, R.layout.topic_tab_detail_pager,null);
