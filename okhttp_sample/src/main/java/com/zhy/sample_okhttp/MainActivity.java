...
//    }
    ...
    public void getHtml(View view)
    {
        ...
        try {
            String word = URLEncoder.encode("阿福","UTF-8");
            url =   url + word;
...
//                .params(params)//
     ...
     * @param view
     */
    public void uploadFile(View view)   // OKhttp上传文件
    {
...
//        params.put("password", "123");
        ...
        String url = "http://192.168.1.200:8080/FileUpload/FileUploadServlet";  // 重点
     ...
     * @param view
     */
    public void multiFileUpload(View view)  // 多文件同时上传
    {
        File file = new File(Environment.getExternalStorageDirectory(), "1.jpg");
...
//        params.put("password", "123");
        ...
        String url = "http://192.168.1.200:8080/FileUpload/FileUploadServlet";
        OkHttpUtils.post()//
    ...
    /*
     * 下载文件(下载到机身内存的根目录中(无文件夹))
     */
    public void downloadFile(View view)
    {
        String url = "http://192.168.1.200:8080/oppo.mp4";
        OkHttpUtils//
                .get()//
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath(), "myemcu_oppo.mp4")//
                {
